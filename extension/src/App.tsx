...
function SourceCard({ source, index }: { source: LegalSource; index: number }) {
  return (
    <div 
      className="bg-white rounded-lg border border-slate-200 overflow-hidden transition-all hover:shadow-md animate-in fade-in slide-in-from-bottom-2"
      style={{ animationDelay: `${index * 80}ms` }}
    >
      {/* Header with title and relevance */}
      <div className="p-3 bg-gradient-to-r from-blue-50 to-slate-50 border-b border-slate-100">
      ...
      {source.summary && (
        <div className="p-3 bg-white">
          <div className="text-xs text-slate-600 leading-relaxed border-l-3 border-blue-400 pl-3 py-1 bg-blue-50/50 rounded-r">
